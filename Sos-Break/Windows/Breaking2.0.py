...
while True:
        os.system("cls")
        print(f"\t\t\t{Red}{Underline}Sos-Breaking-Number 2.0{end}")
        print(f"\t{Default}Наш ВК --->{end} {Blue}https://vk.com/nikitasos1ska, https://vk.com/2pac_jdm, https://vk.com/covidone, https://vk.com/paket20{end}")
...
#            https://vk.com/paket20
        ...
        print(f"{Default}Код написан ими --->{end} {Blue}https://vk.com/nikitasos1ska, https://vk.com/2pac_jdm, https://vk.com/covidone, https://vk.com/paket20{end}")
...
#            https://vk.com/paket20
        ...
        if str(start_input) == "n":
                ...
                print(f"\t\t\tСоздатели кода --> {Blue}https://vk.com/nikitasos1ska, https://vk.com/2pac_jdm, https://vk.com/covidone, https://vk.com/paket20")
                quit()
...
#            https://vk.com/paket20
        ...
        print(f"https://api.whatsapp.com/send?phone={str(number_input)}&text=Hacked%20Cool%20-%20Hackers - Поиск номера в WhatsApp") 
...
#            https://vk.com/paket20
        ...
        if str(cont_input) == "y":
                ...
                time.sleep(2)
                os.system("cls")
                print(f"Над данным кодом работали ---> {Blue}https://vk.com/nikitasos1ska, https://vk.com/2pac_jdm, https://vk.com/covidone, https://vk.com/paket20")
                quit()